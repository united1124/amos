...
<title>test</title>
   ...
   <script type="text/javascript">
		$(document).ready(function(){
			 $('.content').fadeOut("fast").hide().load( "<?php echo base_url()?>index.php/admin/homePage" ).fadeIn('fast');
...
<a href='<?php echo base_url()?>index.php/home/logout'>Logout</a></div>
<div id="menu">
<ul>
   <li><a href="<?php echo base_url()?>index.php/admin/homePage" class="submenu">หน้าแรก</a></li>
   <li ><a href="<?php echo base_url()?>index.php/admin/fromImport" class="submenu">นำเข้าข้อมูล</a> </li>
   <li><a href='#' class="submenu">กำหนดนักศึกษาให้อาจารย์ที่ปรึกษา</a></li>
</ul>
