...
<ul>
  ...
  <li><a class="submenu" href='<?php echo base_url()?>index.php/stu/update'>แก้ไขข้อมูลส่วนตัว</a> 
    <ul>
    </ul>
   </li>
   <li><a class="submenu" href='<?php echo base_url()?>index.php/stu/show'>ดูข้อมูลอาจาร์ที่ปรึกษา</a></li>
